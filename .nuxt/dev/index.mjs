...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Simplifiez la gestion de votre cantine et transport scolaire avec notre solution QR Code innovante."}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"NO-Money Just QR-Code"};
...
const _inlineRuntimeConfig = {
  ...
  "nhostAdminSecret": "nhost-admin-secret",
  "ipx": {
    "baseURL": "/_ipx",
    "alias": {},
    "fs": {
